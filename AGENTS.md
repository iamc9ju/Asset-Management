...
สำหรับงานที่แก้เฉพาะเอกสาร เจ้าของโปรเจกต์อนุญาตให้ Codex สร้างและแก้ไฟล์เอกสารได้ทันทีโดยไม่ต้องรอให้เจ้าของโปรเจกต์พิมพ์เนื้อหาเอง และไม่ต้องรัน Prettier หรือ formatting check เว้นแต่เจ้าของโปรเจกต์สั่งให้ตรวจโดยตรง ให้ตรวจเฉพาะ diff ที่เกี่ยวข้องเท่าที่จำเป็น การอนุญาตนี้ครอบคลุมการแก้ไฟล์เอกสาร แต่ไม่ครอบคลุมการ commit, push หรือ mutation อื่นใน Git หากข้อความปัจจุบันไม่ได้อนุญาตไว้
